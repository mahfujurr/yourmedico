            ...
            <div className=" border border-black/10 w-full max-w-md p-8 space-y-3 rounded-xl bg-cyan-900 text-cyan-100">
                ...
                <div className="flex justify-center space-x-4">
                    ...
                    <button aria-label="Log in with Twitter" className="p-3 rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current  hover:text-blue-500">
                    ...
                    <button aria-label="Log in with GitHub" className="p-3 rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current  hover:text-yellow-500">
                ...
                <p className="text-xs text-center sm:px-6 text-cyan-400">Have an account?
                    <Link to='/login' className="hover:underline text-cyan-100">Login here.</Link>
                </p>
            </div>
        </div>
    );
